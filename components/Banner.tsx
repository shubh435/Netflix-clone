...
const Banner = ({netflixOriginals }:Props) => {
  ...
  return (
    <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end">
        <div className="absolute top-0 -z-20 left-0 w-screen h-[95vh]">
    ...
    <div className="flex space-x-3">
        ...
        <button className="bannerButton bg-[grey]/75">moreinfo <InformationCircleIcon className="h-5 w-5 md:h-8 md:w-8"/></button>
    </div>
    </div>
  )
}
